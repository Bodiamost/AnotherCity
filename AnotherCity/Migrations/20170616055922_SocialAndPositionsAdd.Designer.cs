...
namespace AnotherCity.Migrations
{
    ...
    [Migration("20170616055922_SocialAndPositionsAdd")]
    partial class SocialAndPositionsAdd
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("AnotherCity.Models.Member", b =>
                {
                    b.HasOne("AnotherCity.Models.Positions", "Positio")
                        .WithMany()
                        .HasForeignKey("PositioId");
                });
